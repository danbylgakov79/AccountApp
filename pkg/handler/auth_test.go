...
import (
	"AccountApp"
	"AccountApp/pkg/service"
	mock_service "AccountApp/pkg/service/mocks"
	"bytes"
	"errors"
...
func TestHandler_signUp(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorization, user AccountApp.User)

	testTable := []struct {
		name                string
		inputBody           string
		inputUser           AccountApp.User
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockAuthorization, user AccountApp.User) {
